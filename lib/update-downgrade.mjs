export const GITHUB_RELEASES_BASE =
  'https://github.com/mausalas99/r-plus-cardio/releases/download';
export const STABLE_VERSIONS_RAW_URL =
  'https://raw.githubusercontent.com/mausalas99/r-plus-cardio/main/stable-versions.json';
...
export function buildManualInstallerUrl(version, platform, arch) {
  ...
  let fileName;
  if (platform === 'darwin') {
    fileName = `R+ Cardio-${v}-${macArch}.dmg`;
  } else if (platform === 'win32') {
    fileName = `R+ Cardio-${v}-x64.exe`;
  } else {
