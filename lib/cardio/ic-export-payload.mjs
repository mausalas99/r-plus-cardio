...
export function buildIcExportPayload(patient, opts = {}) {
  ...
  const computed = computeDescongestion({
    ...
    furosemidaAcumuladaMg: sumFurosemidaMg(cardio.diureticSegments, asOfDate),
...
function medEventLabFields(p, cardio, diureticSegs, activeDiuretics, evStore) {
  return {
    ...
    medInicioCells: buildMedInicioCells(cardio.fantasticos, cardio.medSegments),
    medExtra: buildMedExtraCells(cardio.medSegments),
