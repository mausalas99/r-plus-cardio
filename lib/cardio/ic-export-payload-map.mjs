...
/** @param {unknown} fantasticos @param {string[]} names @param {string[]} doses @param {string[]} indicaciones */
function pushFantasticos(fantasticos, names, doses, indicaciones) {
  ...
  for (const f of fantasticos) {
    ...
    indicaciones.push(String(/** @type {any} */ (f).indicacion || '').trim());
  }
}
...
function padMedCells(names, doses, indicaciones) {
  ...
  // Two fillable indicación slots (Anticoagulación / Estreñimiento sentinels)
