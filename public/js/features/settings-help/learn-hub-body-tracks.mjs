...
export function renderLearnHubGuardiaTrack(guardiaCompletedCount, progress, tourProgress, guardiaModuleState) {
  ...
  parts.push('<p class="learn-hub-section-lead">Módulos cortos e independientes. Pulsa una tarjeta para empezar; los completados se pueden resetear y abrir después.</p>');
...
export { SALA_HUB_MODULES, IC_HUB_MODULES };
